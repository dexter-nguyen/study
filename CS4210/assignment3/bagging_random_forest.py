#-------------------------------------------------------------------------
# AUTHOR: Tran Nguyen
# FILENAME: bagging_random_forest.oy
# SPECIFICATION: Compute accuracy of single decision tree, bagging, and Random Forest
...
with open('optdigits.tes', 'r') as testingFile:
  ...
  for k in range(20): #we will create 20 bootstrap samples here (k = 20). One classifier will be created for each bootstrap sample
      ...
      for i, testSample in enumerate(dbTest):
          ...
          #--> add your Python code here
          class_predicted = clf.predict([testSample[0:64]])
          classVotes[i][int(class_predicted)] = classVotes[i][int(class_predicted)] + 1
...
#--> add your Python code here
  ...
  #--> add your Python code here
      class_predicted_rf = clf.predict([testSample[0:64]])
