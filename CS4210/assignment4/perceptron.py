...
# SPECIFICATION: Print the updated accuracy of Perceptron and MLP
...
for w in n: #iterates over n
    ...
    for b in r: #iterates over r
        ...
        for a in range(2): #iterates over the algorithms
            ...
            #--> add your Python code here
            if a==0 and highest_accuracy_perceptron < accuracy:
                highest_accuracy_perceptron = accuracy
                print("Highest Perceptron accuracy so far:",round(highest_accuracy_perceptron,3), ", Parameters: learning rate=",w, ", shuffle=",b)
            if a ==1 and highest_accuracy_mlp < accuracy:
                highest_accuracy_mlp = accuracy
                print("Highest MLP accuracy so far:",round(highest_accuracy_mlp,3), ", Parameters: learning rate=", w,", shuffle=",b)
